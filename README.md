...
- **Audio:** kapitoly 1–7 (`assets/audio/1.m4a`–`7.m4a`) mají nahrávku, 8–17 zatím nic.
...
Portréty postav jsou naskenované/vyfocené stránky z **Jim Kayho Illustrated Edition** (Bloomsbury/Scholastic) — komerční, chráněné dílo, ne volně šiřitelné. Portrét Jamese Pottera je fanouškovská kresba jiné konkrétní autorky (Michelle Winer), staženo z internetu, ne z knihy — jiný typ zdroje, stejné pravidlo použití. Použití je v pořádku jen jako **osobní, neveřejná appka pro rodinu**. Repo **nesmí** být veřejné a GitHub Pages **nesmí** být zapnuté, dokud tyhle obrázky v `assets/` jsou — jinak jde o veřejnou reprodukci cizího autorského díla. Pokud by appka měla být někdy veřejná, portréty by musely být nahrazené něčím jiným (originální/AI ilustrace).
